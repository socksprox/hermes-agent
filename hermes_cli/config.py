...
def migrate_config(interactive: bool = True, quiet: bool = False) -> Dict[str, Any]:
    ...
    # ── Version 29 → 30: seed display.dashboard_chat_surface + curator.consolidate ──
    if current_ver < 30:
        config = read_raw_config()
        touched_v30 = False
        ...
        # OFF by default. Only add the key when a curator section exists and
        # lacks it — never clobber a value the user already set.
        raw_curator = config.get("curator")
